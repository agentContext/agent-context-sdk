...
class App(BaseModel):
    ...
    tokdens: StrictInt = Field(alias="Tokdens")
    create_at: datetime = Field(alias="CreateAt")
    update_at: datetime = Field(alias="UpdateAt")
    __properties: ClassVar[List[str]] = ["Id", "AppName", "PackageName", "Description", "Tokdens", "CreateAt", "UpdateAt"]
