...
namespace agent-context-sdk.Api
{
    ...
    /// </summary>
    public interface IAppGetApiResponse : agent-context-sdk.Client.IApiResponse, IOk<agent-context-sdk.Model.AppListResponse?>, IDefault<agent-context-sdk.Model.ErrorResponse?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IAppIdIdGetApiResponse : agent-context-sdk.Client.IApiResponse, IOk<agent-context-sdk.Model.AppItemResponse?>, IDefault<agent-context-sdk.Model.ErrorResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IAppPkgPkgnameGetApiResponse : agent-context-sdk.Client.IApiResponse, IOk<agent-context-sdk.Model.AppItemResponse?>, IDefault<agent-context-sdk.Model.ErrorResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    /// </summary>
    public interface IAppSearchGetApiResponse : agent-context-sdk.Client.IApiResponse, IOk<agent-context-sdk.Model.AppListResponse?>, IDefault<agent-context-sdk.Model.ErrorResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class AppApi : IAppApi
    {
        ...
        /// </summary>
        public partial class AppGetApiResponse : agent-context-sdk.Client.ApiResponse, IAppGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public agent-context-sdk.Model.AppListResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<agent-context-sdk.Model.AppListResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out agent-context-sdk.Model.AppListResponse? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class AppIdIdGetApiResponse : agent-context-sdk.Client.ApiResponse, IAppIdIdGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// </summary>
            /// <returns></returns>
            public agent-context-sdk.Model.AppItemResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<agent-context-sdk.Model.AppItemResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out agent-context-sdk.Model.AppItemResponse? result)
            {
                result = null;
        ...
        /// </summary>
        public partial class AppPkgPkgnameGetApiResponse : agent-context-sdk.Client.ApiResponse, IAppPkgPkgnameGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
        ...
        /// </summary>
        public partial class AppSearchGetApiResponse : agent-context-sdk.Client.ApiResponse, IAppSearchGetApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
